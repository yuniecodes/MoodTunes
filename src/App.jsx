...
export default function MoodTunes() {
  ...
  const handleLogout = () => {
    setUser(null); setSpotifyToken(null); sessionStorage.clear(); setCurrentPage('login');
                ...
                <div key={track.id} className="bg-white rounded-lg shadow hover:shadow-xl transition overflow-hidden border border-gray-100">
                  ...
                  <div className="p-3 sm:p-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      {track.preview_url && (
                        <button onClick={()=>playPreview(track.preview_url, track.id)} className={`flex-1 py-2 rounded-lg font-semibold transition ${playingTrackId===track.id?'bg-red-500 hover:bg-red-600 text-white':'bg-green-600 hover:bg-green-700 text-white'}`}>
